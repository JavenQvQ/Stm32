...
int COIL_X=0, COIL_Y=0, COIL_Z=0;//X,Y,Z线圈PWM
int ADC_VALUE[3] = {0,0,0};

void limiting_PWM(void)
{
	int amplitude=3500; //PWM满幅是3600 限制在3500,占空比是COIL_X/3600
...
/**
  * @brief  电机PWM幅值,XIN1是PB12，XIN2是PB13，PWMX是TIM1_CH1,YIN1是PB14，YIN2是PB15，PWMY是TIM1_CH4
  * 
  * @param  moto1：电机1PWM
  * @param  moto2：电机2PWM
  * @retval 无
...
/**
  * @brief  控制函数，PID整合函数,每1ms调用一次,通过TIM3中断调用,频率1KHz
  * @param 	无
  * @retval 0
  */
